...
describe('Mars Rovers', () => {
  ...
  it('throws an error if it goes out of bounds to the south', () => {
    const rover = new Rover({ ...initialParams, startingPoint: [0, 9] })
  ...
  it('throws an error if the starting point is not an array of integers', () => {
    expect(() => {
      const rover = new Rover({ ...initialParams, startingPoint: [0.1, 0.1] })
    }).toThrow('ERR_STARTING_POINT_INVALID')
  })
  ...
  it('throws an error if the grid size is not an array of integers', () => {
    expect(() => {
      const rover = new Rover({ ...initialParams, gridSize: [0.1, 0.1] })
    }).toThrow('ERR_GRID_SIZE_INVALID')
  })
